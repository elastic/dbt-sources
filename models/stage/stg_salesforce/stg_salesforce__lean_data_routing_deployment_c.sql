...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'lean_data_routing_deployment_c') }}
...
renamed as (
    ...
    select
        ...
        lean_data_custom_url_fields_c,
        lean_data_custom_email_fields_c,
        lean_data_domain_lookups_c
