...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'ffrr_revenue_recognition_settings_c') }}
...
renamed as (
    ...
    select
        ...
        setup_owner_id,
        system_modstamp,
        ffrr_generate_schedules_log_deletion_c,
        ffrr_disable_schedules_creation_from_contracts_c
