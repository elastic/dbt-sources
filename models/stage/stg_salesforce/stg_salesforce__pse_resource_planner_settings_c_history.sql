...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'pse_resource_planner_settings_c_history') }}
...
renamed as (
    ...
    select
        ...
        pse_availability_percentage_precision_c,
        ...
        pse_resource_search_fieldset_name_c,
        pse_resource_tooltip_field_set_c,
        ...
        pse_show_availability_column_c,
        pse_use_beige_c,
        ...
        setup_owner_id,
        system_modstamp,
        pse_default_urr_end_date_buffer_c,
        pse_default_urr_start_date_buffer_c
