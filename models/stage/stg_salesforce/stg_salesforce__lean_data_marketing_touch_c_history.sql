...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'lean_data_marketing_touch_c_history') }}
...
renamed as (
    ...
    select
        ...
        lean_data_days_to_next_opportunity_stage_c,
        ...
        lean_data_total_accelerated_opportunity_touches_c,
        lean_data_total_generated_opportunity_touches_c,
        lean_data_total_opportunity_touches_c,
