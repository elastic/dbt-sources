...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'lean_data_round_robin_pool_c') }}
...
renamed as (
    ...
    select
        ...
        lean_data_respect_working_hours_schedule_c,
        lean_data_respect_vacation_schedule_c,
        lean_data_respect_holiday_schedule_c,
        lean_data_respect_pausing_schedule_c,
        lean_data_pool_settings_c,
        lean_data_is_conditional_membership_enabled_c,
        lean_data_soql_condition_c,
        lean_data_last_membership_saved_date_c,
        lean_data_last_sync_date_c
