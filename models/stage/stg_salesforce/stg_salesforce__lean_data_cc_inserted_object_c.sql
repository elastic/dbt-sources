...
with source as (
    ...
    select * from {{ source('raw_salesforce', 'lean_data_cc_inserted_object_c') }}
...
renamed as (
    ...
    select
        ...
        lean_data_triggered_object_type_c,
        lean_data_no_rtr_reason_c,
        lean_data_variables_c,
        lean_data_triggered_object_id_c,
        lean_data_multi_ccio_failed_reason_c,
        lean_data_triggered_record_id_c
