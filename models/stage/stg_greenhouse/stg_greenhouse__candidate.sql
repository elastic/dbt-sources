...
with source as (
    ...
    select * from {{ source('raw_greenhouse', 'candidate') }}
...
renamed as (
    ...
    select
        ...
        custom_rank,
        custom_internship_end_date_candidate_1654726863_7944422,
        custom_marital_status_english_,
        custom_marital_status_spanish_,
        custom_gender_spanish_,
        custom_federal_taxpayer_number_rfc_,
        custom_personal_identification_number_curp_,
        custom_gender
