...
with source as (
    ...
    select * from {{ source('raw_netsuite_sa', 'change__approval_policy_history') }}
...
renamed as (
    ...
    select
        ...
        enable_global_object_level_po,
        sod_approvers,
        sod_approvers_group_data,
        sod_no_order_required,
        sod_max__of_approvals_require,
        approvers_group_data,
        itgc_approvers,
        user_offboarding_id,
        user_onboarding_id,
        nonmanaged_bundleapp_deploy_id,
        access_tokenintegration_rec_id,
        partition_date
